        ...
        <footer className="bg-[#0f0f0f] text-white pt-16 pb-8 px-6 md:px-10 rounded-t-[40px]">
            <div className="max-w-[1440px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-20">
                    ...
                    {/* Newsletter and Socials - Spanning 4 columns for more space */}
                    <div className="lg:col-span-5 flex flex-col gap-6 ">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {['f', 'X', 'in', 'y', 't', 'ig'].map((icon, idx) => (
                                <div key={idx} className="bg-white text-black w-10 text-[13px] px-1 flex items-center justify-center rounded-full  font-bold cursor-pointer transition-colors">
                                    {icon} <span className="text-[12px] ml-2"><MdOutlineArrowOutward /></span>
                                </div>
                            ))}
                        </div>
                    </div>

                    {/* Column 1: Services - Spanning 2/3 columns */}
                    <div className="lg:col-span-2 flex  flex-col gap-2 border-l border-[#414141] pl-3 h-fit self-start">
                ...
                {/* SVG Logo */}
                <div className="w-full mb-12 opacity-100">
